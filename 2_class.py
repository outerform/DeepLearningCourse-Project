...
parser.add_argument('--save_path', type=str, default='./models_2class/')
...
# %%
import wandb
wandb.init(project='siim-covid19-detection',name=f'effnetv2-2class_{args.image_size}',config = args)
